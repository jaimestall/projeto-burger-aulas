...
<script>
// Nota-se que neste component não é importado nenhum component

export default {
  // Nomes de componentes são facultativos. Simplesmente boas práticas e organização de código.
  name: "Banner",
};
</script>
...
/* Estilização do título do banner */
#main-banner h1 {
  color: #fff;
  text-align: center;
  font-size: 60px;
